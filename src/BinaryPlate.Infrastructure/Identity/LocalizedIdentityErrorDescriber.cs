namespace BinaryPlate.Infrastructure.Identity;
...
public class LocalizedIdentityErrorDescriber : IdentityErrorDescriber
{
    ...
    public override IdentityError ConcurrencyFailure() =>
        new() { Code = nameof(ConcurrencyFailure), Description = Resource.It_appears_someone_else_has_made_changes_or_deleted_the_data_you_are_updating };
