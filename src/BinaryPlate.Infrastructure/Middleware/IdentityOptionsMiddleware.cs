...
public class IdentityOptionsMiddleware(RequestDelegate next)
{
                                  ...
                                  IOptions<IdentityOptions> identityOptions)
    {
        ...
        if (path.Contains(Login))
            ...
            await ApplyNewIdentityOptionsOnSpecifiedPaths(dbContext, appOptionsService, tenantResolver, identityOptions, path);
