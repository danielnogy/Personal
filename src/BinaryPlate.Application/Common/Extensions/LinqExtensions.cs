...
public static class LinqExtensions
{
    ...
    public static IQueryable<T> OrderBy<T>(this IQueryable<T> query, string name)
    {
        ...
        // Get the OrderBy method using reflection.
    ...
    public static IEnumerable<T> SortBy<T>(this IEnumerable<T> query, string sort)
    {
        ...
        var propertyAndOrder = sort.Split([' ']);
        ...
        else
        {
            ...
            throw new ArgumentException("Invalid sort parameter. Expected format: {PropertyName} {OrderBy}");
        }
