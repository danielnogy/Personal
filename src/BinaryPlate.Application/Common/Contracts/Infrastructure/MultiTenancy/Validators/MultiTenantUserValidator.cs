namespace BinaryPlate.Application.Common.Contracts.Infrastructure.MultiTenancy.Validators;

/// <summary>
/// User validator for multi-tenant application.
/// </summary>
/// <remarks>Initializes a new instance of the MultiTenantUserValidator class.</remarks>
/// <param name="tenantResolver">Instance of the tenant resolver.</param>
public class MultiTenantUserValidator(ITenantResolver tenantResolver) : IUserValidator<ApplicationUser>
{
    ...
    public async Task<IdentityResult> ValidateAsync(UserManager<ApplicationUser> userManager, ApplicationUser user)
    {
        ...
        var combinationExists = await CheckCombinationExists(userManager, user, isAddOperation, tenantResolver);
        ...
        return combinationExists
            ? IdentityResult.Failed(new IdentityError
            {
                ...
                Description = tenantResolver.TenantMode == TenantMode.MultiTenant && !tenantResolver.IsHostRequest
