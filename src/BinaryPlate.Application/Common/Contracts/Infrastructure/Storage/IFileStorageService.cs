...
/// <summary>
/// This interface represents the contract for a file storage service that can be used in multiple cloud storage providers like Azure, AWS, and local servers.
/// </summary>
public interface IFileStorageService
{
    ...
    /// <param name="relativePath">The base directory path where the files should be uploaded.</param>
    /// <param name="fileRenameAllowed">Specifies whether file renaming is allowed.</param>
    /// <param name="baseUri">The base URI to use for generating the file URL (optional).</param>
    /// <param name="cancellationToken">The cancellation token (optional).</param>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the URL of the
    /// uploaded file.
    /// </returns>
    Task<FileMetaData> UploadFile(IFormFile formFile, string relativePath, bool fileRenameAllowed = false, string baseUri = null, CancellationToken cancellationToken = default);

    /// <summary>
    /// Uploads multiple files to the specified directory path.
    /// </summary>
    /// <param name="formFiles">The list of files to upload.</param>
    /// <param name="relativePath">The relative path of the directory where the files should be uploaded.</param>
    /// <param name="fileRenameAllowed">Specifies whether file renaming is allowed.</param>
