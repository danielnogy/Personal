namespace BinaryPlate.Application.Features.Account.Manage.Commands.UpdateUserProfile;
...
public class UpdateUserProfileCommand : IRequest<Envelope<string>>
{
    ...
    public class UpdateUserProfileCommandHandler(ApplicationUserManager userManager,
                                                 IHttpContextAccessor httpContextAccessor) : IRequestHandler<UpdateUserProfileCommand, Envelope<string>>
    {
        #region Public Methods
