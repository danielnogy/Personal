...
public partial class EditRole
{
    ...
    private GetRoleForEditResponse RoleForEdit { get; set; } = new();
    ...
    private async Task GetRole()
    {
        ...
        if (responseWrapper.IsSuccessStatusCode)
            RoleForEdit = responseWrapper.Payload;
        else
    ...
    private async Task SubmitForm()
    {
        ...
        if (!dialogResult.Canceled)
        {
            UpdateRoleCommand = new UpdateRoleCommand
            {
                ...
                IsDefault = RoleForEdit.IsDefault,
                ...
                ConcurrencyStamp = RoleForEdit.ConcurrencyStamp,
            };
