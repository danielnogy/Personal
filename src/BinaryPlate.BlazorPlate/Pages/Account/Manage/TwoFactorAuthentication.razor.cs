...
public partial class TwoFactorAuthentication
{
    ...
    private GetTwoFactorAuthenticationStateResponse GetTwoFactorAuthenticationStateResponse { get; set; }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        if (responseWrapper.IsSuccessStatusCode)
            GetTwoFactorAuthenticationStateResponse = responseWrapper.Payload;
        else
