...
public partial class Avatar
{
    ...
    private GetUserAvatarForEditResponse UserAvatarForEdit { get; set; } = new();
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        {
            UserAvatarForEdit = responseWrapper.Payload;
            if (!string.IsNullOrWhiteSpace(UserAvatarForEdit.AvatarUri))
                UserAvatarForEdit.IsAvatarAdded = true;
        }
        else
        {
    ...
    private async Task AvatarSelected(StreamContent streamContent)
    {
        ...
        try
        {
            ...
            if (responseWrapper.IsSuccessStatusCode)
            {
                ...
                UserAvatarForEdit.IsAvatarAdded = true;
                UserAvatarForEdit.AvatarUri = responseWrapper.Payload.FileUri;
            }
            else
            {
    ...
    {
        UserAvatarForEdit.IsAvatarAdded = false;
        UserAvatarForEdit.AvatarUri = null;
    }
    ...
    private async Task UpdateUserAvatar()
    {
        ...
        if (!dialogResult.Canceled)
        {
            ...
            {
                AvatarUri = UserAvatarForEdit.AvatarUri,
                IsAvatarAdded = UserAvatarForEdit.IsAvatarAdded,
            };
