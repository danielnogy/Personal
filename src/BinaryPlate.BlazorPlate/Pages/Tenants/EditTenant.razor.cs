...
public partial class EditTenant
{
    ...
    private GetTenantForEditResponse TenantForEdit { get; set; } = new();
    ...
    private async Task GetTenant()
    {
        ...
        if (responseWrapper.IsSuccessStatusCode)
            TenantForEdit = responseWrapper.Payload;
        else
    ...
    private async Task SubmitForm()
    {
        ...
        if (!dialogResult.Canceled)
        {
            ...
            {
                Id = TenantForEdit.Id,
                Name = TenantForEdit.Name,
                Enabled = TenantForEdit.Enabled,
                ConcurrencyStamp = TenantForEdit.ConcurrencyStamp,
            };
