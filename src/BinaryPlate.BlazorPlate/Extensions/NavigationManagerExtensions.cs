...
public static class NavigationManagerExtensions
{
    ...
    public static bool TryGetQueryString<T>(this NavigationManager navManager, string key, out T value)
    {
        ...
        if (HttpUtility.ParseQueryString(uri.Query).TryGet(key, out var valueFromQueryString))
        {
    ...
    public static string GetSubDomain(this NavigationManager navManager)
    {
        ...
        switch (dotCount)
        {
            ...
            default:
                {
                    var subDomain = navManagerBaseUri.Split(dot)[0].Split("//")[1];
                    return subDomain;
                }
        }
    }
    ...
    private static bool TryGet(this NameValueCollection queryString, string key, out string value)
    {
