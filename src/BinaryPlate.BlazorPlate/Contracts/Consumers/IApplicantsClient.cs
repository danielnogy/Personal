...
public interface IApplicantsClient
{
    ...
    /// <returns>A <see cref="GetApplicantForEditResponse"/>.</returns>

    #region Public Methods

    Task<ApiResponseWrapper<GetApplicantForEditResponse>> GetApplicant(GetApplicantForEditQuery request);
