...
public interface IAccountsClient
{
    ...
    /// <summary>
    /// Registers the external login provider for the current user.
    /// </summary>
    /// <returns>
    /// A <see cref="ApiResponseWrapper{T}"/> containing the result of the registration operation.
    /// </returns>
    Task<ApiResponseWrapper<LoginResponse>> RegisterExternalLogin();
    ...
    /// </summary>
    /// <returns>A <see cref="ApiResponseWrapper{T}"/> containing the result of the logout operation.</returns>
    Task<ApiResponseWrapper<string>> Logout();
